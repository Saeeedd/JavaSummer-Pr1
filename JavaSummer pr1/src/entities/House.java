...
public class House {
    ...
    public Professor getHeadTeacher () { return headTeacher; };
    public ArrayList<String> getQualities () { return qualities; };
    public Map<integer, Student> getPrefects () { return prefects; };
    //setters
    public void setName (String _name) { name = _name; };
    public void setSchool (School _school) { school = _school; };
    public void setStudents (Vector<Student> _students) { students = _students; };
    public void setHeadTeacher (Professor _headTeacher) { headTeacher = _headTeacher; };
    public void setQualities (ArrayList<String> _qualities) { qualities = _qualities; };
    public void setName (Map<Integer, Student> _prefects) { prefects = _prefects; };
}

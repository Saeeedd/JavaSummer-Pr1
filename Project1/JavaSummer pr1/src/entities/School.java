...
public class School {
    ...
    public void setHouseNames(ArrayList<House> _houses) {
        houses = _houses;
    }


    public void setStudentNames(Vector<Student> _students) {
        students = _students;
    }


    public void setProfessorNames(Vector<Professor> _professors) {
        professors = _professors;
    }


    public void setCourseNames(ArrayList<Course> _courses) {
        courses = _courses;
    }


    public void setYears(ArrayList<Integer> _years) {
        years = _years;
    }
